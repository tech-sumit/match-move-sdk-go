 ...
 * @param autoActivate
 * @param var2faMethod
 * @param var2faDelivery
 * @param var2faValue
 * @param xAuthUserID MatchMove provided hash ID for the user
 * @param cardTypeCode The card type available for the program in the system. Available choices can be retrieved via [Get configured card types](https://developer.matchmove.com/docs/optimus-prime/op_api.yaml/paths/~1users~1wallets~1cards~1types/get)
@return CardFullV1
*/
func (a *CardsApiService) CreateUserWalletCard(ctx context.Context, assocNumber string, refId string, cardDesign string, nameOnCard string, additionalDetails string, autoActivate bool, var2faMethod string, var2faDelivery string, var2faValue string, xAuthUserID string, cardTypeCode string) (CardFullV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue CardFullV1
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/wallets/cards/{card_type_code}"
	localVarPath = strings.Replace(localVarPath, "{"+"card_type_code"+"}", fmt.Sprintf("%v", cardTypeCode), -1)
	...
	localVarFormParams.Add("assoc_number", parameterToString(assocNumber, ""))
	localVarFormParams.Add("ref_id", parameterToString(refId, ""))
	localVarFormParams.Add("card_design", parameterToString(cardDesign, ""))
	localVarFormParams.Add("name_on_card", parameterToString(nameOnCard, ""))
	localVarFormParams.Add("additional_details", parameterToString(additionalDetails, ""))
	localVarFormParams.Add("auto_activate", parameterToString(autoActivate, ""))
	localVarFormParams.Add("2fa_method", parameterToString(var2faMethod, ""))
	localVarFormParams.Add("2fa_delivery", parameterToString(var2faDelivery, ""))
	localVarFormParams.Add("2fa_value", parameterToString(var2faValue, ""))
...
*/
func (a *CardsApiService) CreateUserWalletCardPin(ctx context.Context, pinblock string, xAuthUserID string, cardId string) (InlineResponse2007, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/wallets/cards/{card_id}/pins"
	...
	localVarHeaderParams["X-Auth-User-ID"] = parameterToString(xAuthUserID, "")
	localVarFormParams.Add("pinblock", parameterToString(pinblock, ""))
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
CardsApiService Suspend / Block card
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param cardId Cards id which can be obtained using GET &#x60;/users/wallets&#x60; or GET &#x60;/users/wallets/cards&#x60;
 * @param optional nil or *CardsApiDeleteUserWalletCardOpts - Optional Parameters:
     * @param "Type_" (optional.String) -
@return InlineResponse2006
*/

type CardsApiDeleteUserWalletCardOpts struct {
	Type_ optional.String
}

func (a *CardsApiService) DeleteUserWalletCard(ctx context.Context, cardId string, localVarOptionals *CardsApiDeleteUserWalletCardOpts) (InlineResponse2006, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/wallets/cards/{card_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"card_id"+"}", fmt.Sprintf("%v", cardId), -1)
...
/*
CardsApiService Get card details
...
@return CardFullV1
*/
func (a *CardsApiService) GetUserWalletCardId(ctx context.Context, cardId string, maskNumber string, xAuthUserID string) (CardFullV1, *http.Response, error) {
	var (
...
/*
CardsApiService Get the encrypted card number
...
*/
func (a *CardsApiService) GetUserWalletCardNumer(ctx context.Context, cardId string, xAuthUserID string) (InlineResponse20013, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "users/wallets/cards/{card_id}/number"
	localVarPath = strings.Replace(localVarPath, "{"+"card_id"+"}", fmt.Sprintf("%v", cardId), -1)
...
/*
CardsApiService Reset card pin
Reset Card Pin
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param cardId The &#x60;card_id&#x60; for which the information is being retrieved.
 * @param mode Mode denotes how the system generated PIN is sent to the end user.  | Value | Name | Description | |-----|-----|-------| | M   | Email   | The PIN is delivered via email   | | S   | SMS     | The PIN is delivered via SMS   |
@return InlineResponse2007
*/
func (a *CardsApiService) GetUserWalletCardPins(ctx context.Context, cardId string, mode string) (InlineResponse2007, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/wallets/cards/{card_id}/pins/reset"
	localVarPath = strings.Replace(localVarPath, "{"+"card_id"+"}", fmt.Sprintf("%v", cardId), -1)
...
/*
CardsApiService Retrieve card security code
...
/*
CardsApiService Get configured card types
Retrieve the list of card types supported in the system
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return InlineResponse2002
*/
func (a *CardsApiService) GetUserWalletCardTypes(ctx context.Context) (InlineResponse2002, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/wallets/cards/types"
...
/*
CardsApiService Get cards for user
...
*/
func (a *CardsApiService) PutUserWalletCardId(ctx context.Context, activationCode string, var2faMethod string, var2faDelivery string, var2faValue string, cardId string) (InlineResponse2004, *http.Response, error) {
	var (
	...
	localVarFormParams.Add("activation_code", parameterToString(activationCode, ""))
	localVarFormParams.Add("2fa_method", parameterToString(var2faMethod, ""))
	localVarFormParams.Add("2fa_delivery", parameterToString(var2faDelivery, ""))
	localVarFormParams.Add("2fa_value", parameterToString(var2faValue, ""))
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
...
/*
CardsApiService Re-activate card
...
*/
func (a *CardsApiService) ReactivateUserWalletCardId(ctx context.Context, id string, assocNumber string, refId string, cardId string) (InlineResponse2005, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
