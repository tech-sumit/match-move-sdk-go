...
/*
FundsApiService Create Un-load transaction
 ...
 * @param xAuthUserID The &#x60;user_id&#x60; of the user returned via  GET /users
 * @param cardId The &#x60;card_id&#x60; for which the information is being retrieved. 
 * @param optional nil or *FundsApiDeleteUserWalletCardIdFundsOpts - Optional Parameters:
     * @param "Amount" (optional.Int32) - 
     * @param "Message" (optional.String) - 
     * @param "FundCategoryName" (optional.String) - 
@return InlineResponse20020
*/

type FundsApiDeleteUserWalletCardIdFundsOpts struct {
    Amount optional.Int32
    Message optional.String
    FundCategoryName optional.String
}

func (a *FundsApiService) DeleteUserWalletCardIdFunds(ctx context.Context, xAuthUserID string, cardId string, localVarOptionals *FundsApiDeleteUserWalletCardIdFundsOpts) (InlineResponse20020, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/users/wallets/cards/{card_id}/funds"
	...
	if localVarOptionals != nil && localVarOptionals.FundCategoryName.IsSet() {
		localVarFormParams.Add("fund_category_name", parameterToString(localVarOptionals.FundCategoryName.Value(), ""))
	}
...
/*
FundsApiService Create debit transaction
Initiate a  closed loop debit transaction for a particular users wallet in the system.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FundsApiDeleteUserWalletFundsOpts - Optional Parameters:
     * @param "Email" (optional.String) - 
     * @param "MobileCountryCode" (optional.String) - 
...
type FundsApiDeleteUserWalletFundsOpts struct {
...
func (a *FundsApiService) DeleteUserWalletFunds(ctx context.Context, localVarOptionals *FundsApiDeleteUserWalletFundsOpts) (InlineResponse20022, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.Details.IsSet() {
		localVarFormParams.Add("details", parameterToString(localVarOptionals.Details.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.FundCategoryName.IsSet() {
		localVarFormParams.Add("fund_category_name", parameterToString(localVarOptionals.FundCategoryName.Value(), ""))
	}
...
/*
FundsApiService Cancel pending debits/credits
Cancel  a closed loop transaction in the system which is in intermediate state.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param refHash
@return InlineResponse20020
*/
func (a *FundsApiService) DeleteUserWalletFundsHolding(ctx context.Context, refHash string) (InlineResponse20020, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/wallets/funds/holdings/{ref_hash}"
	localVarPath = strings.Replace(localVarPath, "{"+"ref_hash"+"}", fmt.Sprintf("%v", refHash), -1)
...
/*
FundsApiService Get Debits/Credits of cards
...
@return InlineResponse20020
*/
func (a *FundsApiService) GetUserWalletCardIdFunds(ctx context.Context, xAuthUserID string, cardId string) (InlineResponse20020, *http.Response, error) {
	var (
...
/*
FundsApiService Get pending debit/credits
...
/*
FundsApiService Get P2P transactions
Retrieve p2p closed loop transactions for a users wallet in the system
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xAuthUserID MatchMove provided hash ID for the user
@return InlineResponse20024
*/
func (a *FundsApiService) GetUserWalletFundsTransfer(ctx context.Context, xAuthUserID string) (InlineResponse20024, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/wallets/funds/transfers"
...
/*
FundsApiService Create load transaction
Initiate a closed loop load transaction from the wallet to the specified card
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xAuthUserID The &#x60;user_id&#x60; of the user returned via  GET /users
 * @param cardId The &#x60;card_id&#x60; for which the information is being retrieved. 
 * @param optional nil or *FundsApiPostUserWalletCardIdFundsOpts - Optional Parameters:
     * @param "Amount" (optional.Int32) - 
     * @param "Message" (optional.String) - 
     * @param "FundCategoryName" (optional.String) - 
@return InlineResponse20020
...
type FundsApiPostUserWalletCardIdFundsOpts struct {
    Amount optional.Int32
    Message optional.String
    FundCategoryName optional.String
}

func (a *FundsApiService) PostUserWalletCardIdFunds(ctx context.Context, xAuthUserID string, cardId string, localVarOptionals *FundsApiPostUserWalletCardIdFundsOpts) (InlineResponse20020, *http.Response, error) {
	var (
...
/*
FundsApiService Create credit or transfer transaction
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FundsApiPostUserWalletFundsOpts - Optional Parameters:
     * @param "Email" (optional.String) - 
     * @param "MobileCountryCode" (optional.String) - 
     * @param "Mobile" (optional.String) - 
     ...
     * @param "Details" (optional.String) - 
     * @param "ForwardedFor" (optional.String) - 
     * @param "HashedPan" (optional.String) - 
     * @param "FundCategoryName" (optional.String) - 
     * @param "Type_" (optional.String) - 
     * @param "LoadCard" (optional.Bool) - 
     * @param "CardId" (optional.String) - 
@return InlineResponse20021
*/

type FundsApiPostUserWalletFundsOpts struct {
    Email optional.String
    MobileCountryCode optional.String
    Mobile optional.String
    ...
    Details optional.String
    ForwardedFor optional.String
    HashedPan optional.String
    FundCategoryName optional.String
    Type_ optional.String
    LoadCard optional.Bool
    CardId optional.String
}

func (a *FundsApiService) PostUserWalletFunds(ctx context.Context, localVarOptionals *FundsApiPostUserWalletFundsOpts) (InlineResponse20021, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.ForwardedFor.IsSet() {
		localVarFormParams.Add("forwarded_for", parameterToString(localVarOptionals.ForwardedFor.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.HashedPan.IsSet() {
		localVarFormParams.Add("hashed_pan", parameterToString(localVarOptionals.HashedPan.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.FundCategoryName.IsSet() {
		localVarFormParams.Add("fund_category_name", parameterToString(localVarOptionals.FundCategoryName.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.LoadCard.IsSet() {
		localVarFormParams.Add("load_card", parameterToString(localVarOptionals.LoadCard.Value(), ""))
	}
...
/*
FundsApiService Retry pending debits/credits
Retry confirming a closed loop transaction in the system which is in intermediate state.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param refHash
@return InlineResponse20020
*/
func (a *FundsApiService) PostUserWalletFundsHolding(ctx context.Context, refHash string) (InlineResponse20020, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
FundsApiService Create Refund
Issue a partial or full refund out of the wallet. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param type_
 * @param optional nil or *FundsApiPostUserWalletRefundsOpts - Optional Parameters:
     * @param "Amount" (optional.Int32) - 
     * @param "Details" (optional.String) - 
@return InlineResponse20023
*/

type FundsApiPostUserWalletRefundsOpts struct {
    Amount optional.Int32
    Details optional.String
}

func (a *FundsApiService) PostUserWalletRefunds(ctx context.Context, type_ string, localVarOptionals *FundsApiPostUserWalletRefundsOpts) (InlineResponse20023, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/wallets/refund/{type}"
...
/*
FundsApiService Update transfer transaction
Confirm the two staged transfer transaction for legacy systems
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xAuthUserID MatchMove provided hash ID for the user
@return InlineResponse20020
*/
func (a *FundsApiService) PutUserWalletFunds(ctx context.Context, xAuthUserID string) (InlineResponse20020, *http.Response, error) {
	var (
...
/*
FundsApiService Confirm pending transfer
Confirm a p2p closed loop transactions for a user in the system.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xAuthUserID MatchMove provided hash ID for the user
@return InlineResponse20020
*/
func (a *FundsApiService) PutUserWalletFundsTransfers(ctx context.Context, xAuthUserID string) (InlineResponse20020, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
