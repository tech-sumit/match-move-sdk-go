...
/*
WalletsApiService Create Wallet
...
@return WalletFullV1
*/
func (a *WalletsApiService) CreateUserWallet(ctx context.Context, xAuthUserID string) (WalletFullV1, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue WalletFullV1
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/wallets"
...
/*
WalletsApiService Retrieve Wallet
Retrieve user&#x27;s wallet details and information.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param xAuthUserID MatchMove provided hash ID for the user
@return WalletFullV1
*/
func (a *WalletsApiService) GetUserWallet(ctx context.Context, xAuthUserID string) (WalletFullV1, *http.Response, error) {
	var (
