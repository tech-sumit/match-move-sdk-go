...
// APIClient manages communication with the Payment Relay API vpaymentrelay
...
type APIClient struct {
	...
	ConsumerProvidersApi *ConsumerProvidersApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ConsumerProvidersApi = (*ConsumerProvidersApiService)(&c.common)
